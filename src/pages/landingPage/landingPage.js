...
function LandingPage() {
  ...
  const sliderData = [
    {
      url: `${LTLSliderImage1}`,
      captionHeader: "AL MU'IZZ VENTURE",
      captionDescription: "Making Investment Easy & Secure",
    },
    {
      url: `${LTLSliderImage2}`,
      captionHeader: "Real Estate",
      captionDescription: "Islamabad  Peshawar Quetta Rawalpindi",
    },
    {
      url: `${LTLSliderImage3}`,
      captionHeader: "Equipments By AL MU'IZZ VENTURE",
  ...
  useEffect(() => {
    ...
    document.title = "AL MU'IZZ VENTURE - Making investment easy & secure";
    window.scrollTo(0, 0);
            ...
            <div className="flex justify-between px-4 mt-28 w-full divide-x divide-gray">
              <div className="w-60 pb-12">
                ...
                <p className="font-graphikRegular text-gray-700 text-base mt-3 flex text-center items-center justify-center">
                  Near Blessing Tower , H13, Islamabad
                </p>
                <p className="flex items-baseline mt-2 justify-center font-graphikBold">
                  <span className="font-graphikBold text-4xl mr-1">
                    5 min from Siri Nagar Highway
                  </span>
                </p>
              </div>
